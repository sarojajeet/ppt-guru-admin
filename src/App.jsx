...
import TextEditor from "./components/wordEditor/TextEditor";
  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col">
      ...
      <Routes>
        ...
        {/* <Route path="/test-editor/:documentId" element={<TextEditor />} /> */}
              ...
              <main className="flex-1 flex flex-col relative overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-8 scroll-smooth pb-20">
                  <Routes>
                    ...
                    <Route
                      path="/users"
                      element={<Users db={db} updateDb={updateDb} />}
                    />
                    <Route
                      path="/plans"
