...
const EMPTY = {
  ...
  documentAllow: '',snipAllow: '', slideCount: '', billingType: 'monthly',
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      documentAllow: Number(form.documentAllow),
        snipAllow: Number(form.snipAllow),   // ✅ NEW
        ...
        <div style={{flex:1, overflowY:'auto', padding:'28px 32px', display:'flex', flexDirection:'column', gap:24}}>
          ...
          <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:16}}>
            ...
            <Field label="Documents Allowed">
             ...
             <Field label="Snips Allowed">   {/* ✅ NEW */}
    {inputF('snipAllow', 'number', '20')}
  </Field>
          </div>
    ...
    onMouseLeave={e=>{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {plan.snipAllow > 0 && <><span style={{color:'#334155'}}>|</span><span>✂️ {plan.snipAllow} snips</span></>}
        </div>
      </div>
